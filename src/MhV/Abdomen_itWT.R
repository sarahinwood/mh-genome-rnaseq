...
dds_tissue <- mhv1_dds[,mhv1_dds$stage=="Adult"]
##re-level tissue factor
dds_tissue$Tissue <- factor(dds_tissue$tissue, levels=c("Head", "Thorax", "Abdomen", "Ovaries", "Venom"))
dds_tissue$Flowcell <- factor(dds_tissue$Flowcell)

design(dds_tissue) <- ~Flowcell+Tissue
dds_tissue <- DESeq(dds_tissue)

# don't detect any DE if using lfc=1

## abdo head
abdo_head <- results(dds_tissue, contrast=c("Tissue", "Abdomen", "Head"), alpha = 0.05)
summary(abdo_head)
## Order based of padj
...
## abdo thorax
abdo_thorax <- results(dds_tissue, contrast=c("Tissue", "Abdomen", "Thorax"), alpha = 0.05)
summary(abdo_thorax)
## Order based of padj
...
## abdo thorax
abdo_venom <- results(dds_tissue, contrast=c("Tissue", "Abdomen", "Venom"), alpha = 0.05)
summary(abdo_venom)
## Order based of padj
...
## abdo ovaries 
abdo_ovaries <- results(dds_tissue, contrast=c("Tissue", "Abdomen", "Ovaries"), alpha = 0.05)
